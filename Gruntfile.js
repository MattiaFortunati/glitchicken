module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    dist: {
      src: ['src/js/ga_mod.js','src/js/custom.js','src/js/text.js','src/js/TinyMusic.js','src/js/game.js'],
  ...
  grunt.registerTask('default', ['concat','uglify', 'processhtml', 'htmlmin','compress','sizecheck','clean']);
};